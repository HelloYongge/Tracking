...
plt.xlabel("time(s)")
plt.ylabel("dist_x(m)")
plt.plot(time, kf.X_posterior_[:, 0], "r--", label="KF_CV_Update", linewidth=2)
plt.plot(time, kf.X_prior_[:, 0], "y--", label="KF_CV_Predict", linewidth=2)
...
plt.xlabel("time(s)")
plt.ylabel("dist_y(m)")
plt.plot(time, kf.X_posterior_[:, 1], "r--", label="KF_CV_Update", linewidth=2)
plt.plot(time, kf.X_prior_[:, 1], "y--", label="KF_CV_Predict", linewidth=2)
...
plt.plot(time, kf.X_posterior_[:, 2], "r--", label="KF_CV_Update", linewidth=2)
plt.plot(time, kf.X_prior_[:, 2], "y--", label="KF_CV_Predict", linewidth=2)
plt.legend()

plt.figure(4)
plt.xlabel("time(s)")
plt.ylabel("vel_y(m/s)")
plt.plot(time, kf.X_posterior_[:, 3], "r--", label="KF_CV_Update", linewidth=2)
plt.plot(time, kf.X_prior_[:, 3], "y--", label="KF_CV_Predict", linewidth=2)
plt.legend()
